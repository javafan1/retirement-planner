...
final class SocialSecurityAnalyzerInputMatrix {
    ...
    static List<Row> rows() {
        return List.of(
                ...
                new Row("Configured projection end date", Use.NOT_USED, Use.USED, Use.REFERENCE_ONLY),
                new Row("Configured projection length", Use.NOT_USED, Use.USED, Use.REFERENCE_ONLY),
