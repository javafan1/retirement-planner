...
//
//    private final Label beginningAssetsLabel;
//    private final Label investmentGrowthLabel;
//    private final Label guaranteedIncomeLabel;
//    private final Label expensesLabel;
//    private final Label endingAssetsLabel;
//    private Projection projection;
//    private int currentYearIndex;
...
//        yearLabel = new Label();
//
//        beginningAssetsLabel = new Label();
//        investmentGrowthLabel = new Label();
//        guaranteedIncomeLabel = new Label();
//        expensesLabel = new Label();
//        endingAssetsLabel = new Label();
//
...
//        }
//
//        this.projection = engine.project(plan);
//
...
//
//        displayCurrentYear();
//        //display(projection.getFirstYear());
//    }
//
//    private void displayCurrentYear() {
//
...
//
//        yearLabel.setText(
//                String.valueOf(year.getCalendarYear()));
//
//        beginningAssetsLabel.setText(
//                currency.format(year.getBeginningInvestableAssets()));
//
...
//
//        expensesLabel.setText(
//                currency.format(year.getExpenses()));
//
//        endingAssetsLabel.setText(
//                currency.format(year.getEndingInvestableAssets()));
//    }
